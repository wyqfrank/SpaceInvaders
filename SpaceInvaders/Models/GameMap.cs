...
//    {
//        private Dictionary<Entity, (int,int)>[,] MapLayout { get; }
//        public GameMap(int width, int height)
//        {
//            MapLayout = new Dictionary<Entity, (int, int)>[height, width];

//            for (int i = 0; i < height; i++)
//            {
//                for (int j = 0; j < width; j++)
//                {
//                    MapLayout[i, j] = new Dictionary<Entity, (int, int)>();
//                }
//            }

//        }
//        public Dictionary<Entity, (int, int)>[,] GetMapLayout()
//        {
//            return MapLayout;
//        }
